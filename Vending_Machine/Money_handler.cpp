...
class Money_handler{
    ...
    static void return_changes(User &user){
        ...
        std::cout<<"Please collect your balance of : "<< balance<<std::endl;
        std::cout<<(int)balance/25<<"x 25 cents"<<std::endl;
        balance=(int)balance%25;
        std::cout<<(int)balance/10<<"x 10 cents"<<std::endl;
        balance=(int)balance%10;
        std::cout<<(int)balance/5<<"x 5 cents"<<std::endl;
        balance=(int)balance%5;
        std::cout<<(int)balance/1<<"x 1 cents"<<std::endl;
