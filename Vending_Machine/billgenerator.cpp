...
class bill_generator{
    ...
    for(auto map_iterator:Map) {
            ...
            std::cout<<std::setw(8)<<"$ "<<(map_iterator).first.price<<std::setw(4)<<std::right<<"|"; 
            std::cout<<std::setw(7)<<std::right<<(map_iterator).second<<std::setw(8)<<std::right<<"|";
            std::cout<<std::setw(7)<<"$ "<<(map_iterator).first.price*(map_iterator).second<<std::setw(6)<<std::right<<"|";
            std::cout<<std::endl;
    ...
    std::cout<<std::endl;
    std::cout<<std::setw(75)<<std::setfill('-')<<""<<std::endl;
    std::cout<<"|"<<std::setw(35)<<std::setfill(' ')<<"TOTAL :"<<std::setw(31)<<"$ "<<total_price<<std::setw(6)<<std::right<<"|"<<std::endl;
    std::cout<<std::setw(75)<<std::setfill('-')<<""<<std::endl;
    }
};